...
<section class="story-area left-text center-sm-text">
        <div class="container" style="margin-top:3em;">
                ...
                <form action="<?php echo base_url(); ?>users/register_restaurant" method="post" class="form-style-1 placeholder-1">
                        <div class="row">
<!--								minimum length and maximum length are used-->
                                <div class="col-md-6"> <input minlength="8" maxlength="50" class="mb-20" name="name" type="text" placeholder="Name of Restaurant">  </div>
                                <div class="col-md-6"> <input minlength="6" maxlength="50" class="mb-20" name="email" type="email" placeholder="E-mail">  </div>
